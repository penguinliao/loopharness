...
```bash
git clone https://github.com/penguinliao/loopharness.git loopharness
cd loopharness
bash install.sh
...
GitHub 仓库从 v1.4 起使用 `loopharness`，公开产品展示名为 LoopHarness；Python 包名暂时保留为 `claude_hh`。旧 GitHub 地址由 GitHub 自动跳转到新仓库。
